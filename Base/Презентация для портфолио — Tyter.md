...
Небольшая история о прототипе приложения для создателей историй.

Приветствую всех интернет бродяг. Меня зовут [Сергей](https://buharev.com/). Я занимаюсь проектированием и дизайном интерфейса. Сегодня я расскажу вам, как я делал прототип [приложения Tyter](https://tyter.ru/), которое предназначено для создания сценариев и расскадровок. Ну чтож, поехали. 
...
Платформа даёт возможность быстрее доносить свои истории до вашей аудитории (заказчика, подписчиков, зрителей) с помощью единой экосистемы продукта. Ещё Tyter даёт возможность аудитории помогать Вам создавать истории целой командой.
...
Текст сценария и раскадровки используются на всём пути от препродакшена вплоть до самой съёмки и обработки отснятого материала и его маркетинга.
...
— Ролям: режиссёр, оператор, сценарист, продюссер, актёр, операторов-постановщик и т.д. Общий список всех профессий, которые причастны к созданию нарратива дохерища. Посмотрите сами —> Посмотреть
— Навыкам: кто-то умеет делать всё с помощью клавиш, кто-то нет. Кому-то удобнее читать сценарий с мобильного устройства.
...
На ней изображен кабинет сценарной группы, которая отвечает за оправдания тупости или умности персонажа в истории. Например, если ваш персонаж встаёт в тупик, то Вы как сценарист обращаетесь к такой группе, чтобы решить проблему с историей в сценарии. 

В таких группах, обычно сидят завсегдатые мужички в возрасте и придумывают сальные шуточки для сцен, диалогов и т.д. Но что ещё важнее, обратите внимание на их доску позади. Что это? Это раскадровка сценария, которую сделали эти люди для визуализации сценария.

![[Pasted image 20210804150843.png]]

### Черновые варианты
В самом начале проектирования приложения я просто набросал черновые идеи, без кликабельности и просил будущих пользователей предугадать, что будет при нажатии на определённые элементы интерфейса, попутно изучая как эти элементы работают в других приложениях. После изучения пользовательского опыта и общения с несколькими сценаристами, собрал несколько пользовательских портретов.
...
**Пример одной ветки User Story Map: **
...
Небольшой абстракный список из того, что можно делать в приложении, который превратился в список основной функциональности:
